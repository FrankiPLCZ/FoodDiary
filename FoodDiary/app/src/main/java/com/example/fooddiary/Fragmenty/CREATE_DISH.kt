...
import com.example.fooddiary.databinding.FragmentCreateDishBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class CREATE_DISH(val c:Context) : Fragment() {

private lateinit var b:FragmentCreateDishBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentCreateDishBinding.inflate(inflater,container,false)
