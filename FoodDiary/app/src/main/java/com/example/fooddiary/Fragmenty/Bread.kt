...
import com.example.fooddiary.databinding.FragmentBreadBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class Bread(val c:Context) : Fragment() {

private lateinit var b:FragmentBreadBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentBreadBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"5")
    }
}