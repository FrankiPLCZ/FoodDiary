...
import com.example.fooddiary.databinding.FragmentDSnackBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class Dish_Snack(val c:Context) : Fragment() {

private lateinit var b:FragmentDSnackBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentDSnackBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"11")
    }
}