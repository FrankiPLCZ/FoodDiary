...
import com.example.fooddiary.databinding.FragmentDDinnerBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class Dish_Dinner(val c:Context) : Fragment() {

private lateinit var b:FragmentDDinnerBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentDDinnerBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"10")
    }
}