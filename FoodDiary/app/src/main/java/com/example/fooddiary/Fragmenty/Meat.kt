...
import com.example.fooddiary.databinding.FragmentMeatBinding

class Meat(val c:Context) : Fragment() {

private lateinit var b:FragmentMeatBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentMeatBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"3")
    }
}