...
class Vegetables(val c:Context) : Fragment() {

    private lateinit var b: FragmentFruitsBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentFruitsBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"2")
    }
}