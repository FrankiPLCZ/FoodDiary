...
import com.example.fooddiary.databinding.FragmentOtherBinding

class Other(val c:Context) : Fragment() {

private lateinit var b:FragmentOtherBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentOtherBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"6")
    }
}