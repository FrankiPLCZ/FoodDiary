...
import com.example.fooddiary.databinding.FragmentDLunchBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class Dish_Lunch(val c:Context) : Fragment() {

private lateinit var b:FragmentDLunchBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentDLunchBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"9")
    }
}