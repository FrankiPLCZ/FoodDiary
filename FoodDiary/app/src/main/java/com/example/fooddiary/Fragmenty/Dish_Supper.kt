...
import com.example.fooddiary.databinding.FragmentDSupperBinding
import com.example.fooddiary.databinding.FragmentFruitsBinding

class Dish_Supper(val c:Context) : Fragment() {

private lateinit var b:FragmentDSupperBinding
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        b =  FragmentDSupperBinding.inflate(inflater,container,false)
    ...
    override fun onResume() {
        ...
        b.rv.adapter = FoodAdapter(c,db,"12")
    }
}