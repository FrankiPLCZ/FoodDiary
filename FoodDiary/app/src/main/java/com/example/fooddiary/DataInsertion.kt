...
class DataInsertion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cur = db.query(TableInfo.TABLE_NAME, null, BaseColumns._ID +
        ...
        b.groupsex.setOnCheckedChangeListener { radioGroup, i ->
            val RB:RadioButton = findViewById(i)
    ...
    fun InsertDB(v:View){
        ...
        if(!name.isNullOrEmpty()&&!weight.isNullOrEmpty()&&!age.isNullOrEmpty()&&
                    !height.isNullOrEmpty()&&b.groupsex.checkedRadioButtonId!=-1&&
                     b.group.checkedRadioButtonId!=-1){
            ...
            finish()
        }else Toast.makeText(applicationContext,"Please fill all the information",
